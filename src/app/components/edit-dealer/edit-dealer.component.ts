...
export class EditDealerComponent implements OnInit {
  ...
  constructor(private dialogRef: MatDialogRef<EditDealerComponent>,private globalService:GlobalVariable,private router: Router, private http: HttpClient, private service: ApiService, private dialog: MatDialog, private toastr: ToastrService) { }
